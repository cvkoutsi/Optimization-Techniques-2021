...
hold off;
title('Minimum of $f_1(x)$','Interpreter','latex');
...
hold off;
title('Minimum of $f_2(x)$','Interpreter','latex');
xlabel('$x$','Interpreter','latex');
...
hold off;
title('Minimum of $f_3(x)$','Interpreter','latex');
xlabel('$x$','Interpreter','latex');
ylabel('$f_3(x)$','Interpreter','latex');
